...
# 全メンバー（事前入力）
all_members = [
    "しおん","そら","なるみ","まこ", "こゆ", "まあや","ひまり", "ゆー", "あんな", "はるか","ともか","くるみ","りえる","あやか","まひろ","みお","まゆか","ほのか","みさき","れいこ","まゆこ",
    "ハルカ","ひな","あゆみ","ゆりな","あやみ","さな"
]

# 曲とメンバーの対応表（一般曲）
songs = {
    "ポニーテールとシュシュ": {"しおん","そら","なるみ","まこ", "こゆ", "まあや","れいこ",
    "ゆー", "あんな", "はるか","さな","まゆか","りえる","あやか","まひろ","みお"},
    "サマーとはキミと私なりっ!!": {"しおん","そら","なるみ","まこ", "こゆ", "まあや","ひまり",
    "ゆー", "あんな", "はるか","れいこ",ゆりな"},
    "ナツマトペ": {"まひろ","そら","なるみ","ほのか", "ひな", "あやみ","さな",
    "りえる", "あんな", "はるか"},
    "Super Summer": {"みさき","そら","まこ", "こゆ", "まあや","ひまり", "ゆー", "あんな","ともか"},
    ...
    "｢君の音だったんだ｣": {"しおん","そら","なるみ","まこ", "こゆ", "まあや","ひまり", "ゆー", "あんな", "はるか","ともか","くるみ"}
}
