...
# 曲とメンバーの対応表（一般曲）
songs = {
    "ポニーテールとシュシュ": {"まこ", "ゆー", "ひじり", "あんな", "そら"},
    "サマーとはキミと私なりっ!!": {"ちさと", "なるみ", "まい", "あんな", "ひじり", "そら"},
    "ナツマトペ": {"ひまり", "ひじり", "ちさと", "あんな"},
    "Super Summer": {"ひじり", "ゆー", "ちさと"},
    "WHAT IS LOVE?": {"ひまり", "ちさと", "まい", "なるみ", "そら"},
    "アイドルライフスターターパック": {"しおん", "まい", "まあや", "なるみ", "ひまり",
                                         "ちさと", "ゆー", "まこ", "ともか"},
    "恋愛決壊警報": {"ちさと", "ともか", "あんな", "そら", "まこ", "しおん", "なるみ", "まあや", "ひじり", "ひな"},
    "僕らのユリイカ": {"はるか", "ひじり", "ひな", "あんな", "しおん", "ちさと","なるみ","まあや","ともか"},
    "ブルーハワイレモン": {"そら", "こゆ", "ひまり", "ゆー", "まこ", "あんな", "はるか","ひじり","ともか","なるみ","まあや","ひな"},
    "ぷりきゅきゅ": {"ちさと", "ひじり", "まい", "あんな", "そら", "ひな", "こゆ", "ゆー", "ともか", "なるみ"},
    "SWEET STEP": {"ともか", "そら", "ゆー", "まこ", "しおん", "あんな", "ひまり"},
    "らぶげっちゅ": {"ゆー", "ひな", "なるみ", "こゆ", "ひじり","ちさと"},
    "｢君の音だったんだ｣": {"ともか", "なるみ", "まあや"}
}
