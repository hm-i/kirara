...
all_members = [
    ...
    "ゆう", "あんな", "はるか","ともか","くるみ","りえる","あやか","まひろ","みお","まゆか","ほのか","みさき","れいこ","まゆこ",
    "ハルカ","ひな","あゆみ","ゆりな","あやみ","さな","まき
    "
]
...
songs = {
    ...
    "絶対アイドル辞めないで【まちかね】": {"そら", "しおん", "なるみ", "まこ", "ちさと", "ひまり", "あんな", "まい", "こゆき", "まあや", "ひじり"},
    "ヘビーローテーション【まちかね】": {"そら", "しおん", "なるみ", "まこ", "ちさと", "はるか", "まい", "ゆう", "こゆき", "まあや", "ひじり", "まひろ", "みお", "みさき", "ひな", "まゆ", "あやみ"},
    "Panorama【まちかね】": {"そら", "しおん", "なるみ", "まこ", "ちさと", "ひまり", "まい", "ひじり", "まひろ", "みお", "ゆりな"},
    "Shining bright【まちかね】": {"そら", "まこ", "ちさと", "ひまり", "まい", "ひじり"},
    "♡♡♡わんだーらんど【まちかね】": {"しおん", "くるみ", "ほのか", "まき"},
    "今、恋をしている【まちかね】": {"なるみ", "ひまり", "あんな", "はるか", "まい", "ゆう", "こゆき", "まあや", "ひじり", "みお", "まゆ", "あやか"},
    "君セン！【まちかね】": {"まい", "あゆみ", "さな", "ひな", "ほのか", "まき", "るか", "ゆりな", "りえる", "あやか"},
    "ゆめみるプリマドンナ【まちかね】": {"あんな", "はるか", "まあや", "ひじり", "ひな", "まき", "ゆりな", "あやか"},
    "キュートなキューたい【まちかね】": {"しおん", "ちさと", "ひまり", "まい", "ひじり", "ひな", "ゆりな", "あやか"},
    "I♡シズム【まちかね】": {"そら", "しおん", "ひまり", "こゆき", "くるみ", "ほのか"},
    "AI SEE CHAT【まちかね】": {"ちさと", "まゆか", "みお", "さな", "ひな"},
    "BRAVE GROOVE【まちかね】": {"そら", "しおん", "ひまり", "こゆき", "ひじり", "まひろ", "くるみ", "ゆりな", "あやみ"},
    "CHEER UP【まちかね】": {"まこ", "ちさと", "ひじり", "まひろ", "くるみ", "みお", "みさき", "るか"},
    "初恋のこたえ。【まちかね】": {"なるみ", "まこ", "ちさと", "ひまり", "はるか", "まい", "れいこ", "ほのか", "まゆ"},
    "のびしろグリッター【まちかね】": {"そら", "しおん", "なるみ", "ひまり", "まい", "まひろ"},
    "BANG BANG【まちかね】": {"そら", "ちさと", "ひまり", "まい", "まひろ", "ゆりな"},
    "チュープリ【まちかね】": {"しおん", "はるか", "まい", "こゆ", "まあや", "りえる"},
    "世界でいちばんアイドル【まちかね】": {"なるみ", "あんな", "はるか", "まい", "こゆ", "まひろ"},

    # ===== 尼涼祭 =====
    "きにしないっ！【尼涼祭】": {"まあや", "はるか", "こゆ", "ゆう", "まこ", "まい", "ひじり", "ひまり", "そら"},
    "サマーリボン【尼涼祭】": {"ゆう", "はるか", "こゆ", "まい", "あんな", "まこ", "ひまり"},
    "夏恋ジレンマ【尼涼祭】": {"あんな", "まあや", "まこ", "ひじり"},
    "生まれたトキから白歴史【尼涼祭】": {"あんな", "くるみ", "まい", "はるか", "ひまり"},
    "ゼリーの海で背泳ぎ眩しいや【尼涼祭】": {"まこ", "まあや", "こゆ", "ひじり", "そら"},
    "Kiss&Bite Me!【尼涼祭】": {"あんな", "くるみ", "しおん", "ゆう", "そら", "ひじり", "ひまり"},
    "いちご完全犯罪【尼涼祭】": {"くるみ", "しおん", "こゆ", "そら"},

    # ===== 単独 =====
    "言い訳Maybe【単独】": {"そら", "しおん", "なるみ", "まこ", "ちさと", "ひまり", "あんな", "ともか", "はるか", "まい", "ゆう", "こゆき", "まあや", "ひじり", "まい", "まゆ", "みお", "れいこ"},
    "絶対アイドル辞めないで【単独】": {"そら", "しおん", "なるみ", "まこ", "ちさと", "ひまり", "あんな", "はるか", "まい", "こゆき", "まあや", "ひじり"},
    "ヘビーローテーション【単独】": {"そら", "しおん", "なるみ", "まこ", "ちさと", "ひまり", "あんな", "はるか", "まい", "ゆう", "こゆき", "まあや", "ひじり", "まゆ", "まひろ", "みお", "みさき", "ひな", "るか", "ゆりな"},
    "Panorama【単独】": {"そら", "しおん", "なるみ", "まこ", "ちさと", "ひまり", "はるか", "ひじり", "まひろ", "みお", "ゆりな"},
    "Shining bright【単独】": {"そら", "まこ", "ちさと", "ひまり", "まい", "ひじり"},
    "劇薬中毒【単独】": {"しおん", "なるみ", "あんな", "はるか", "まい", "ひな", "ほのか", "まゆ", "るか"},
    "きゃわぱっぴんどうー【単独】": {"ちさと", "まひろ", "くるみ", "さな", "ほのか", "るか", "まゆ", "あやか"},
    "呪って呪って【単独】": {"しおん", "なるみ", "あんな", "はるか", "ひじり", "まひろ", "ほのか", "まゆ"},
    "溺れ！マイラバー【単独】": {"しおん", "なるみ", "あんな", "はるか", "まい", "ゆう", "こゆき", "みお", "まゆ"},
    "Same numbers【単独】": {"そら", "まこ", "あんな", "はるか", "まい", "ゆう", "こゆき", "まあや", "ひじり", "れいこ", "まひろ", "ゆりな"},
    "The 5th【単独】": {"なるみ", "ちさと", "あんな", "はるか", "まい", "ゆう", "まあや", "みお", "さな", "ほのか"},
    "きゅんかわ人生【単独】": {"しおん", "ちさと", "あんな", "はるか", "まい", "こゆき", "まあや", "まゆ", "るか"},
    "チョコレートメランコリー【単独】": {"そら", "るみ", "ちさと", "あんな", "はるか", "まい", "ゆう", "まあや", "ひじり", "あゆみ", "みお"},
    "LOVEマシーン【単独】": {"そら", "しおん", "まこ", "あんな", "はるか", "まい", "ゆう", "こゆき", "まあや"},
    "アイしちゃってます♡【単独】": {"ちさと", "あんな", "はるか", "みお", "さな", "ほのか", "ゆりな"},
    "LIKEY【単独】": {"そら", "しおん", "まこ", "ちさと", "ひまり", "あんな", "はるか", "まい", "あゆみ"},
    "Sweetie/ME:I【単独】": {"そら", "まこ", "ひまり", "はるか", "まい", "こゆき", "まあや", "ひじり", "まひろ", "ゆりな"},
    "LOOK AT ME【単独】": {"そら", "まこ", "はるか", "まい", "こゆき", "みお", "れいこ"},
    "sweettimer【単独】": {"そら", "しおん", "なるみ", "ちさと", "あんな", "はるか", "まい", "ひじり", "あやか", "みお"},
    "冬空ラプソディー【単独】": {"なるみ", "ひまり", "あんな", "はるか", "まい", "ゆう", "こゆき", "あゆみ"},
}
